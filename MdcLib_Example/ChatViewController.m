...
- (void)viewDidLoad {
    ...
    // demo get history 1 room nao đó.
    // timestamp tinh bang giay (second)
    // limit : lượng tin nhắn muốn lấy về. (> 0)
    [[MdcLib sharedInstance] getHistoryConversation:@"100003697" limited:2 timestamp:@"1499788232"callback:^(NSDictionary * _Nullable data) {
        //
        NSLog(@"History here: %@",data);
    }];
}
